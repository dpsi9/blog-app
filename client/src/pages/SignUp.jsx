...
const SignUp = () => {
  ...
  return (
    <div className='min-h-screen mt-20'>
      ...
      <p className='text-sm mt-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam sed ducimus illum eveniet hic iusto ex qui a consequuntur voluptate!</p>
        </div>
        {/*right  */}
        <div className="flex-1">
